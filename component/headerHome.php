      ...
      <nav class="">
        ...
        >
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul
              class="flex mx-2 font-semibold flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white"
            >
              <li>
                <a
                  href="#"
              ...
              <li>
                <button
                  ...
                  class="flex items-center justify-between w-full py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto"
                >
                  Category
                  <svg
                    class="w-5 h-5 ml-1"
                ...
                <div
                  id="dropdownNavbar"
                  class="z-10 hidden font-normal bg-white divide-y rounded-lg shadow w-44 0"
                >
                  <ul
              ...
              <li>
                <a
                  href="#"
                  class="block py-2 pl-3 flex pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0"
                >
