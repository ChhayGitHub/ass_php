        ...
        <div class="my-5 mx-5">
            ...
            <form method="post" action="./create.php">
                <div class="relative z-0 w-96 mb-6 group">
                    <input type="text" name="name" id="category_name" class="block py-2.5 px-0 w-96 text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <textarea name="description" id="description" rows="4" class="my-2 block p-2.5 w-96 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Write your description here..."></textarea>
